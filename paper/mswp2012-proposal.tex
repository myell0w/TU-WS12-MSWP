...
The ultimate goal of the Modern Voluntary Health-Care System is to create and publish an e-health platform. This platform is based on a bonus malus system to give users an easy-understandable overview on how healthy they live.\\

Therefore the project is split in both a scientific and an engineering part. The scientific part aims at searching for technical methods to encourage people to live healthier. For this purpose we try to evaluate and answer some questions, such as:
