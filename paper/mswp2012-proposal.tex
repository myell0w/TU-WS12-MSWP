...
Recent studies show that more and more people are getting obese these days due to an unhealthy lifestyle and way too less exercisement, especially in the so called western society. Many studies and health reports in Europe and America describe the problem and show an increasing trend towards being overweight. The biggest problem being the situation getting worse and worse - especially children are rapidly becoming a big part of the problem, the risk of being overweight is about 30 percent\footnote{\url{http://news.stanford.edu/news/2004/july21/med-obesity-721.html}}. \\

Studies\citep{rki:2012} show, that about 23 Percent of the people in Germany are obese nowadays. Being overweight not only affects your attractiveness, it can lead to very serious health problems like hypertension, asthma, diabetes and other cardiovascular problems.  \\

In the Forbes List for the fattest nation, Austria ranks on place 52 with a fat rate of 57.1\%.\footnote{\url{http://www.forbes.com/2007/02/07/worlds-fattest-countries-forbeslife-cx_ls_0208worldfat_3.html}}. Figure \ref{fig:obese_in_eu_pdf} shows a rather recent statistic of the situation in 25 European countries, divided by sex.
...
One reason for the negative trend of childhood overweight are bad role models. Parents living an unhealthy lifestyle affect and influence their children. A recent study suggests that at-risk children are identifyable in their first years of life and tries to identify various risk factors \footnote{\url{http://news.stanford.edu/news/2004/july21/med-obesity-721.html}}. With increased age it gets harder to get in shape, the goal should be to teach children at young ages how to become and stay fit. In the future this negative trend will lead to an increased financial claim in our health care system - more and more people need expensive health treatments because of diseases caused by being obese over the years.  \\
...
\begin{itemize}
	...
	The modern health care system should use and gather knowledge on what motivates people to stay in shape, especially in the field of gamification.
\end{itemize}
...
The approach to create a game out of tasks for sick people is not new. Dealing with traumatized children by example is nowadays often combined with a game. There are several different developments of games to fit the needs of different patients and problem fields. Furthermore there are very successful social gamifications like "Foursquare" \footnote{\url{https://foursquare.com/about/}} where people check in to places and earn achievements. All of that to keep track of what friends are doing. There is a high scientific potential in our idea because it combines many of already given approaches with existing infrastructure and organizations. For example a hospital can keep track of their patients health status after surgeries or treatments remote. A good idea would be to use the gathered data for better observation of diabetics. Hardware to gather the additional data is already available (see \footnote{\url{http://www.bgstar.com/web/ibgstar}}). These possibilities to collect data lead to more knowledge of different diseases and effectiveness of treatments. By example collection the data of stuff people eat and how much they do physical workouts combined with the actual disease can help creating specialized therapies and new approaches to improve existing ones.\\

\subsection{Open questions}
There are many studies about the influence of games in everyday life. Some scientists (see Jane McGonigal) are trying to use games to let people learn to get the most out of their lifes. Her experiments show that habits changed during playing a game with real world content like a global lack of oil are kept by most of the players even after ending the game. These experiments were made with small groups of 500 to 1700 people as a sort of proof of concept. No one knows what impact it may have when millions of people are achieving a healthier life through various gaming strategies and what comes out of the motivation they put into it. So many questions in the area of wide field gamification are still not answerable.

\subsection{Innovative apsects}
