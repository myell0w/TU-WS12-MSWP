...
The prototyping shall be executed in a horizontal manner, that means there should be a fully featured user interface before starting over with any kind of business logic implementation. The advantage of an horizontal approach is, similar to an experimental one, the perfect compatibility with user centered design. Of course this requires a strict separation of user interface and business logic implementation.
