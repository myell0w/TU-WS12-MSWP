...
\textbf{Description:} Establish user needs regarding an mobile app and get infos about expectations of such an app \\
...
\textbf{Dependencies:} None\\
\textbf{Description:} Establish if and which social health communities (e.g. tracking plattforms) our users are using and find out how to integrate these partner into the system. \\
\textbf{Responsible person(s):} Research Team, Users\\
...
\textbf{Goal(s) and expected Results:} Redesigned system and mobile clients (Version 2.0, Milestone M4)\\
