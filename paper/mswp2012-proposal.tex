...
%Als Vorgehensmodell für dieses Projekt wurde das User Centered Design ausgewählt. Um ein effektives, interaktives System zu bauen müssen die Benutzer identifiziert und ihre Auf- gaben und Bedürfnisse studiert werden. User Centered Design ist ein iterativer Prozess, der dieses Vorhaben unterstützt und der im Wesentlichen folgende vier Phasen durchläuft[10]:
%1. Analyse des Nutzungskontextes
%2. Definition der Anforderungen
%3. Konzeption und Entwurf/Prototyping 4. Evaluation
%Im Rahmen dieser Arbeit sollen für das Projekt In-Kontakt die Phasen 1 bis 3 durchlaufen werden.

\subsection{User Centered Design}
We chose User Centered Design as the procedure model for the modern health care system.

\begin{figure}[tb]
	\centering
		\includegraphics[width=1\textwidth]{images/UCD.pdf}
	\caption{User Centered Design}
	\label{fig:images_UCD}
\end{figure}
