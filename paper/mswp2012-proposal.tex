...
\begin{tabular}{| p{3cm} | p{2cm} | p{2cm} | p{2.5cm} | l |}
\hline
Member & Full-time / Part-time & Position & Duration & Overall costs \\
\hline
\hline
project manager 1 & FT & manager & start - end & \EUR{140.000} \\
\hline
co-project manager 2 &  FT & manager & start - end  & \EUR{130.000} \\
\hline
quality manger 3 & FT & manager & start - end  & \EUR{130.000} \\
\hline
...
\hline
reserarcher 1 &  FT  & employee & start - end  & \EUR{80.000} \\
\hline
reserarcher 2 & FT  & employee & start - end  & \EUR{80.000} \\
\hline
reserarcher 3 & PT & employee & start - end  & \EUR{40.000} \\
\hline
reserarcher 4 & PT & employee & middle - end & \EUR{20.000} \\
\hline
reserarcher 5 & PT & employee & middle - end & \EUR{20.000}  \\
\hline
...
\begin{tabular}{| p{4cm} | p{2cm} | p{2cm} | p{2cm} | p{2cm} |}
	...
	%&&&&\\
	%\hline
	Testing devices & 4 & \EUR{500} & 0 & \EUR{500} \\
	\hline
	Books (research, dev) & NA & \EUR{500} & 0 & \EUR{500}\\
	\hline
	Notebooks & 5 & \EUR{800} & 0 & \\
	\hline
	Printer & 3 & \EUR{1500} & 0 &\\
	\hline
	Server & 1 & 200 & 50 &  \\
	\hline
	Internet & 1 & 50 & 50 &  \\
...
das anwerben von partner benötigt einiges an reisen
zum bewerben des projektes gehört gereist
für die befragungen muss man an den ort der befragung reisen
