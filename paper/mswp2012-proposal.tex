...
\subfigure[part 2]{\includegraphics[width=5cm]{images/gantt/Gantt_part12.png}}
\subfigure[part 1]{\includegraphics[width=5cm]{images/gantt/Gantt_part1.png}}
\caption{Gantt Chart}
\end{figure}

\begin{figure}\centering
\subfigure[part 4]{\includegraphics[width=5cm]{images/gantt/Gantt_part22.png}}
\subfigure[part 3]{\includegraphics[width=5cm]{images/gantt/Gantt_part2.png}}
\caption{Gantt Chart}
\end{figure}
...
%\includegraphics[width=6cm]{images/gantt/Gantt_part1.png}
%\caption{Gantt part 1}
%\label{fig:ganttpart1}
%\end{minipage}
%\begin{minipage}{.4\textwidth}
%\includegraphics[width=6cm]{images/gantt/Gantt_part2.png}
%\caption{Gantt part 2}
%\label{fig:ganttpart2}
%\end{minipage}
%\end{figure}
...
\begin{tabular}{| p{3cm} | p{2cm} | p{2cm} | p{2.5cm} | p{2.5cm} | l |}
\hline
Member & Full-time / Part-time & Position & costs per hour & Duration & Overall costs \\
\hline
\hline
project manager & FT & manager & & start - end & \\
\hline
co-project manager &  FT & manager & & start - end  & \\
\hline
quality manger & FT & manager & & start - end  & \\
\hline
strategy memeber 4 & FT &  middle-manager & & start with version 1.0  & \\
\hline
strategy memeber 4 & FT &  middle-manager &  & start with version 1.0  & \\
\hline
reserarcher 1 &  FT  & & & start - end   & \\
\hline
reserarcher 2 & FT  & & & start - end  & \\
\hline
reserarcher 3 & PT & & & start - end  & \\
\hline
reserarcher 4 & PT & & & middle - end & \\
\hline
reserarcher 5 & PT & & & middle - end &  \\
\hline
security expert & FT & & & start - end &  \\ 
\hline
usability \& design engineer 1 + 2 & FT & & & start - end  & \\
\hline
web dev 1 & FT & & & dev \& update & \\
\hline
web dev 2 & FT & &  & dev \& update & \\
\hline
web dev 3 & FT & &  & dev & \\
\hline
web dev 4 & FT & &  & dev & \\
\hline
mobile dev 1 & FT & &  & dev \& update & \\
\hline
mobile dev 2 & FT & &  & dev \& update & \\
\hline
mobile dev 3 & FT & &  & dev & \\
\hline
mobile dev 4 & FT & &  & dev & \\
...
Workplace with licenses consisting of:
...
\begin{itemize}
	...
	\item {...}
\end{itemize}
Makes around \EUR{1500} - \EUR{2000}  per employee. \\

\subsection{Material}
Once:\\
Printer in the Office 3 $\times$ \EUR{1500} \\
Testing devices (Android phones and iPhones) 4 $\times$ \EUR{500} \\
Books for research and development about \EUR{500} \\
Notebooks for managers 5 $\times$ \EUR{800} \\
\\
Monthly:\\
Server \EUR{50} by renting mailserver, fileserver and repository \\
Internet \EUR{50} \\
\\

\subsection{Travel}

%hm, wieviele reisen sind nötig? 

\subsection{Miscellaneous}

%--miete: 500€ monatlich? keine ahnung, wo liegen die preise?
%--strom, 
%telefon, 
%wasser, 
%heizung im büro
%werbekosten für die gewinnung dre nutzer und partner: folder und sowas
%befragung: vorbereitung, nen ort für die durchführung, die personen die teilnehmen sollten ne kleinigkeit bekommen, auswertung
